...
if [ "$1" == "" ]; then
  ...
  docker build -t=registry.cn-hangzhou.aliyuncs.com/haoshuwei24/csi-ossplugin:$version-$GIT_SHA ./
  docker push registry.cn-hangzhou.aliyuncs.com/haoshuwei24/csi-ossplugin:$version-$GIT_SHA
fi
